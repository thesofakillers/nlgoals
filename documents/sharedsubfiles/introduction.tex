...
other. In short, we aim to address the question \textit{\textbf{how can natural language be used to
address goal misgeneralization in offline RL?}} We frame this question in the larger context of goal
specification in RL
\citep{white_unifying_2017,liu_goal-conditioned_2022,bansal_specification-guided_2022}: \textit{When
is a goal specification good?} \textit{What is a feasible, sensible way to specify goals?}
\textit{Can goal specification methods be used in a complementary manner?} These are some of the
more general questions we wish to address at least partly in this work.
