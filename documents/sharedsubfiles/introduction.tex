...
other. In short, we aim to address the questions \textit{\textbf{how can natural language be used to
address goal misgeneralization in offline RL? Are NL-enabled offline RL algorithms more or less
susceptible to the issue?}} We frame these questions in the larger context of goal specification in
RL \citep{white_unifying_2017, liu_goal-conditioned_2022, bansal_specification-guided_2022}:
