...
and OOD generalization. \Citet{yang_safe_2021} focus on developing operationally safe RL algorithm
by proposing a modular \textit{constraint interpreter} capable of mapping NL constraints to spatial
and temporal representations of hidden states. \Citet{deepmind_MIA_2022} and
