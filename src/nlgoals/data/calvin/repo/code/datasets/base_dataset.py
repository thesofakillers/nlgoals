...
class BaseDataset(Dataset):
    ...
    def __init__(
        ...
        self.id_to_task = (
            ...
            "open_drawer", "place_in_drawer", "place_in_slider", "push_blue_block_left",
            ...
            "rotate_red_block_left", "rotate_red_block_right", "stack_block",
            "turn_off_led", "turn_off_lightbulb", "turn_on_led", "turn_on_lightbulb",
            "unstack_block",
        )
        # fmt: on
